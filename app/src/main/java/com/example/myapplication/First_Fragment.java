...
public class First_Fragment extends Fragment {
    ...
    private void initList() {
        ...
        one.setImageOneId(R.drawable.p1);
        one.setImageTwoId(R.drawable.p2);
        one.setImageThreeId(R.drawable.p3);
        one.setType(1);
        one.save();
        ...
        one1.setImageOneId(R.drawable.p3);
        one1.setImageTwoId(R.drawable.p2);
        one1.setImageThreeId(R.drawable.p1);
        one1.setType(1);
        one1.save();
