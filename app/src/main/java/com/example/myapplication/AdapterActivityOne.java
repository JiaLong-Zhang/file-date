...
public class AdapterActivityOne extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AdapterActivityOne(ActivityClass activityClass){
    ...
    public void initList(){
        ...
        List<ActivityClass> list1=DataSupport.where("type=? and title!=?","1",activityClass.getTitle()).limit(5).find(ActivityClass.class);
...
//        notifyDataSetChanged();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType){
            ...
            case TYPE_2:
                View viewTwo =LayoutInflater.from(parent.getContext()).inflate(R.layout.item_type_one_2,parent,false);
    ...
    class MyVeiwHorlder2 extends RecyclerView.ViewHolder{
        ...
        public MyVeiwHorlder2(View itemView) {
            ...
            title = (TextView) itemView.findViewById(R.id.title_One);
        }
    }
